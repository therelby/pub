...
class UtShippingOverrideCodeAddCoupon extends RunWeb {

    static void main(String[] args) {
        new UtShippingOverrideCodeAddCoupon().testExecute([
    ...
    def test() {
        ...
        tryLoad()
        webAdminShippingOverrideCode.navigate()
        assert !webAdminShippingOverrideCode.addNewCodeAndCheckErrorMessage(null, null, null, null, false)
        tryLoad()
        webAdminShippingOverrideCode.navigate()
        assert !webAdminShippingOverrideCode.addNewCodeAndCheckErrorMessage("ABC10", "10", null, null, false)

        tryLoad()
        webAdminShippingOverrideCode.navigate()
        assert webAdminShippingOverrideCode.addNewCodeAndCheckErrorMessage(null, '10', '11', 'Free Shipping', true)
    }
