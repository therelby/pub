...
abstract class UtPriceTileWarrantyModalATCUCCommercialOption extends UtPriceTileWarrantyModalAddToCart{
    ...
    private void testingWarrantyModalAddToCartUpdateCoverage(String itemNumber, String url, Integer userId, String itemType, boolean isSafeware, boolean hasWarning){
        ...
        String expectedWarrantyDescription = warranty[0]["cart_warranty_description"]
        String actualWarrantyDescription = cartItem.getAccessoryDescription()

        assert (actualWarrantyDescription == expectedWarrantyDescription)
