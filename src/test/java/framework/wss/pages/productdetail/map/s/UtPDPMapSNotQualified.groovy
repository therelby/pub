...
class UtPDPMapSNotQualified extends hUtPDPMapS{

    def test() {

        setup('mwestacott', 'MAP PDP S Not qualified unit test',
                ['product:wss', 'tfsProject:Webstaurant.StoreFront',
                 'keywords:unit test, pdp, map style S, not qualified ',
                 "PBI: 382240",
                 'logLevel:info'])
    ...
    void runTests(String url, String itemType, String p1, String p4, boolean hasLogin){
        ...
        testingAddToCart(mapStyle, p1, p4, hasLogin, false)
    }
}
